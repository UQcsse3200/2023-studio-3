...
public class DesertGameScreen extends ScreenAdapter {
    ...
    private static final String[] desertGameTextures = {};
    private static final String[] desertGameBGM = {"sounds/background/desert/desert_bgm.ogg"};
    private static final String[] desertGameAmbience = {
    ...
    private void loadAssets() {
        ...
        resourceService.loadTextures(desertGameTextures);
    ...
    private void unloadAssets() {
        ...
        ResourceService resourceService = ServiceLocator.getResourceService();
        resourceService.unloadAssets(desertGameTextures);
    }
