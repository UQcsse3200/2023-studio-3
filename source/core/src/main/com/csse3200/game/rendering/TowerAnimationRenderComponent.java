...
/**
 * Subclass of the AnimationRenderComponent, specifically for use by the TowerFactory class
 * to build animations for in game defensive towers
 *
 * using the animation found at https://opengameart.org/content/pixel-turret-animation
 * Renders animations from a texture atlas on a tower.
 *
 * <p>Example usage:
 *
 * <pre>
 ...
 */
public class TowerAnimationRenderComponent extends RenderComponent {
  private static final Logger logger = LoggerFactory.getLogger(TowerAnimationRenderComponent.class);
   ...
   */
  public TowerAnimationRenderComponent(TextureAtlas atlas) {
    this.atlas = atlas;
