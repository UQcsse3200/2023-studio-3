...
public class EnemyTest {
    ...
    private List<Integer> drops = List.of(1, 2);

    private List<String> views = List.of("a", "b", "c");
    ...
    void shouldCreateEnemy() {
        BaseEnemyConfig enemyB = new BaseEnemyConfig(drops, views, List.of("c"));
        int id = enemyB.getId();

        BaseEnemyConfig enemy = new BaseEnemyConfig(drops, views, List.of("c"));
        assertEquals(String.format(baseConfigString, id + 1, "[c]", drops, views, "a"),
                enemy.toString());

        BaseEnemyConfig enemy2 = new BaseEnemyConfig(
                4, 5, drops, views, List.of("c"), 6);
    ...
    @Test
    void idGeneration() {
        BaseEnemyConfig enemy1 = new BaseEnemyConfig(drops, views, List.of("c"));

        BaseEnemyConfig enemy2 = new BaseEnemyConfig(drops, views, List.of("c"));
    ...
    void notEnoughViewException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            BaseEnemyConfig enemy2 = new BaseEnemyConfig(1, 1, drops, views, List.of("c"), 1);
        });
    ...
    void testDamageStateChange() {
        BaseEnemyConfig enemy = new BaseEnemyConfig(1, 10, drops, views, List.of("c"), 1);
